...
import TicketTableManage from "./TicketTableManage";

function ProjectManageDisplay({ updateProject }) {
      ...
      <Grid container spacing={3}>
        ...
        <Grid item xs={12} md={6} lg={6}>
          ...
          >
            ...
            <TicketTableManage tickets={projectTickets} />
          </Paper>
        </Grid>
...
export default ProjectManageDisplay;
